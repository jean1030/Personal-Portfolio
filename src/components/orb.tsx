...
export default function Orb({
  ...
  useEffect(() => {
    ...
    const updateHoverFromPoint = (clientX: number, clientY: number) => {
      ...
      // Keep hover responsive across the whole orb while staying strongest near center.
      targetHover = Math.max(0, 1 - radius / 1.2);
    };
  ...
  return <div ref={ctnDom} className="orb-container size-[820px] mx-auto" />;
}
