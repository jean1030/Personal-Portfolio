                    ...
                    <div key={project.title} className="bg-gray-800 px-8 pt-8 md:pt-12 md:px-10 lg:pt-16 lg:px-20 rounded-3xl relative z-0 after:content-[''] after:absolute after:inset-0 after:z-10 overflow-hidden after:outline-2 after:outline after:-outline-offset-2 after:rounded-3xl after:outline-white/20 after:pointer-events-none sticky" style={{top: `calc(64px + ${index * 20}px)`}}>
                        <div className="lg:grid lg:grid-cols-2 lg:gap-16">
                            <div className="lg:pb-16">
                                ...
                                <h3 className="font-[calistoga] text-2xl md:text-4xl md:mt-5 mt-2">{project.title}</h3>
